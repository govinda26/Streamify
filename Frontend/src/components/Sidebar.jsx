  ...
  return (
    <>
      <aside className="group fixed inset-x-0 bottom-0 z-40 w-full shrink-0 border-t border-white bg-[#121212] px-2 py-2 sm:absolute sm:inset-y-0 sm:max-w-[70px] sm:border-r sm:border-t-0 sm:py-6 sm:hover:max-w-[250px] lg:sticky lg:max-w-[250px]">
        <ul className="flex justify-around gap-y-0 sm:sticky sm:top-[106px] sm:min-h-[calc(100vh-130px)] sm:flex-col">
          <li>
            <NavLink
              to="/home"
              className={({ isActive }) =>
          ...
          <li className="hidden sm:block">
            ...
            >
              <span className="inline-block w-5 shrink-0 sm:group-hover:mr-4 lg:mr-4">
                ...
                >
                  <path
                    d="M9 4H5.5C4.11929 4 3 5.11929 3 6.5V16.5C3 17.8807 4.11929 19 5.5 19H15.5C16.8807 19 18 17.8807 18 16.5V13M9 15H6.5V12.5L16.5 2.5C17.3284 1.67157 18.6716 1.67157 19.5 2.5C20.3284 3.32843 20.3284 4.67157 19.5 5.5L9 15Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
          ...
          <li className="hidden sm:block">
            ...
            >
              <span className="inline-block w-5 shrink-0 sm:group-hover:mr-4 lg:mr-4">
                ...
                >
                  <path
                    d="M16 17V15C16 13.3431 14.6569 12 13 12H5C3.34315 12 2 13.3431 2 15V17M21 17V15C20.9986 13.7789 20.3456 12.6471 19.2622 12.0011M15.5 1.29076C16.5911 1.88415 17.2496 2.98969 17.2496 4.20038C17.2496 5.41107 16.5911 6.51661 15.5 7.11M12.5 4.2C12.5 5.85685 11.1569 7.2 9.5 7.2C7.84315 7.2 6.5 5.85685 6.5 4.2C6.5 2.54315 7.84315 1.2 9.5 1.2C11.1569 1.2 12.5 2.54315 12.5 4.2Z"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
