            ...
            <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
                ...
                <div className="w-full">
                    ...
                    <div className="flex gap-4">
                        <button
                            onClick={handleLike}
                            className={`group inline-flex items-center gap-x-1 outline-none ${isLiked ? "text-[#ae7aff]" : ""
                                }`}
                        >
                            <svg
                        ...
                        <button
                            ...
                            className={`group inline-flex items-center gap-x-1 outline-none ${isDisliked ? "text-[#ae7aff]" : ""
                                }`}
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
