...
function MyChannelPage() {
  const videos = useMemo(() => [], []); // keep empty for "No videos uploaded" state
        ...
        <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
          ...
          <div className="px-4 pb-4">
            ...
            <ul className="no-scrollbar sticky top-[66px] z-[2] flex flex-row gap-x-2 overflow-auto border-b-2 border-gray-400 bg-[#121212] py-2 sm:top-[82px]">
              <li className="w-full">
                <button className="w-full cursor-pointer border-b-2 border-[#ae7aff] bg-white px-3 py-1.5 text-[#ae7aff] transition-colors">
                  Videos
                </button>
              </li>
              <li className="w-full">
                <button className="w-full cursor-pointer border-b-2 border-transparent px-3 py-1.5 text-gray-400 transition-colors hover:text-white">
                  Playlist
                </button>
              </li>
              <li className="w-full">
            ...
            {videos.length === 0 ? (
              <div className="flex justify-center p-4">
                <div className="w-full max-w-sm text-center">
                  ...
                  <button className="mt-4 inline-flex items-center gap-x-2 bg-[#ae7aff] px-3 py-2 font-semibold text-black transition-all duration-150 hover:scale-[1.03] hover:bg-[#9f86ff]">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
              ...
              <div className="p-4">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                  {videos.map((v) => (
                    <article
                      key={v.id}
                      className="rounded border border-white/10 bg-[#141414] p-2"
                    >
                      <div className="aspect-video w-full overflow-hidden rounded bg-black/40" />
                      <h4 className="mt-2 line-clamp-2 text-sm font-medium text-gray-100">
                        {v.title}
                      </h4>
