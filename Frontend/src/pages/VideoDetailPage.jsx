      ...
      <div className="flex min-h-[calc(100vh-66px)] sm:min-h-[calc(100vh-82px)]">
        ...
        <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0">
          <div className="flex w-full flex-wrap gap-4 p-4 lg:flex-nowrap">
            <div className="col-span-12 w-full lg:flex-[2]">
                ...
                <div className="absolute inset-0">
                  {video?.videoFile ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center rounded bg-black/40">
                      {videoLoading ? "Loading video…" : "No video source"}
                    </div>
                  )}
                </div>
              </div>
              ...
              >
                    ...
                    <div className="flex items-center justify-between gap-x-4 md:justify-end lg:justify-between xl:justify-end">
                      <div className="flex overflow-hidden rounded-lg border">
                        ...
                        <button
                          ...
                          data-like={comments.length}
                          data-like-alt={comments.length}
                        >
                          <span className="inline-block w-5 group-focus/btn:text-[#ae7aff]">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="absolute right-0 top-full z-10 hidden w-64 overflow-hidden rounded-lg bg-[#121212] p-4 shadow shadow-slate-50/30 hover:block peer-focus:block">
                          ...
                          <ul className="mb-4">
                            {[
                              ...
                              <li key={playlist} className="mb-2 last:mb-0">
                                <label
                                  className="group/label inline-flex cursor-pointer items-center gap-x-3"
                                  htmlFor={`${playlist}-checkbox`}
                                >
                                  <input
                                    type="checkbox"
                  ...
                  <div className="flex items-center gap-x-4">
                    <div className="mt-2 h-12 w-12 shrink-0">
                      <img
                        ...
                        alt={ownerUsername || "channel"}
                        className="h-full w-full rounded-full object-cover"
                      />
                    </div>
                    <div className="block">
                      <p className="text-gray-200">
                        {ownerName || ownerUsername || "Channel"}
                      </p>
                ...
                <div className="h-5 overflow-hidden group-focus:h-auto">
                  <p className="text-sm">
                    {video?.description ||
                      "Dive into the world of tech with our latest tutorial!"}
                  </p>
                </div>
              </div>
              ...
              <div className="fixed inset-x-0 top-full z-[60] h-[calc(100%-69px)] overflow-auto rounded-lg border bg-[#121212] p-4 duration-200 hover:top-[67px] peer-focus:top-[67px] sm:static sm:h-auto sm:max-h-[500px] lg:max-h-none">
                <div className="block">
                  ...
                  <form onSubmit={handleCommentSubmit} className="flex flex-col gap-2">
                    ...
                    <button
                      type="submit"
                      className="self-end rounded bg-[#ae7aff] px-3 py-1 text-sm font-semibold text-black disabled:opacity-50"
                ...
                <hr className="my-4 border-white" />
                {commentsLoading ? (
                  <div className="py-4 text-sm text-gray-300">Loading comments…</div>
                ) : (
                        ...
                        <div className="mt-2 h-11 w-11 shrink-0">
                          <img
                            src={
                              ...
                              "https://images.pexels.com/photos/18148932/pexels-photo-18148932/free-photo-of-woman-reading-book-on-a-bench.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
                            }
                            alt={comment.author?.username || "viewer"}
                            className="h-full w-full rounded-full object-cover"
                          />
                        </div>
                        <div className="block">
                          <p className="flex items-center text-gray-200">
                            {comment.author?.fullName || comment.author?.username || "Viewer"} ·{" "}
                            <span className="text-sm">{formatTimeAgo(comment.createdAt)}</span>
                          </p>
                          <p className="text-sm text-gray-200">
                            @{comment.author?.username || "viewer"}
                          </p>
              ...
              <div className="flex flex-col gap-3">
                {recommended.map((item) => (
                  <Link
                    key={item._id}
                    to={`/video/${item._id}`}
                    className="flex gap-3 rounded border border-white/10 p-2 transition hover:border-[#ae7aff]"
                  >
                    <div className="relative w-40 shrink-0 overflow-hidden rounded">
                      ...
                      />
                      <span className="absolute bottom-1 right-1 rounded bg-black/70 px-1.5 text-[11px] font-semibold">
                ...
                {!recommended.length && !videoLoading ? (
                  <p className="text-sm text-gray-400">No recommended videos yet.</p>
                ) : null}
              </div>
            </aside>
          </div>
